      ...
      child: Scaffold(
        body: RawKeyboardListener(
          ...
          child: Container(
            ...
            child: Stack(
              children: [
                ImageFade(image:CachedNetworkImageProvider(widget.serie.cover),fit: BoxFit.cover,height: MediaQuery.of(context).size.height,width: MediaQuery.of(context).size.width),
                                                          ...
                                                          children: [
                                                            Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                Text((seasons[selected_season].episodes[index].duration == null)? "":seasons[selected_season].episodes[index].duration
                                                                  , style: TextStyle(
